...
namespace MSCLInstaller
{
    ...
    public partial class Advanced : Window
    {
        ...
        public Advanced(bool core)
        {
            ...
            switch (MD5FileHashes.MD5HashFile(Path.Combine(Storage.gamePath, Storage.selectedGame == Game.MSC ? "mysummercar_Data" : "mywintercar_Data", "Mono", "mono.dll")))
            {
        ...
        {
            string monoPath = Path.Combine(Storage.gamePath, Storage.selectedGame == Game.MSC ? "mysummercar_Data" : "mywintercar_Data", "Mono", "mono.dll");
